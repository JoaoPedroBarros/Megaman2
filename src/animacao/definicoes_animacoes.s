...
struct_animacao_controller:
        ...
        .eqv struct_animacao_controller.FRAME           12      # frame de animacao atual
        .eqv struct_animacao_controller.WAIT_TIMER      16      # timer de espera ateh executar a proxima instrucao

        .eqv struct_animacao_controller.TAMANHO         20      
...
# instruction set
        ...
        .eqv OP_SETFRAME        3       # OP_SETFRAME, n: muda o frame de animacao
        .eqv OP_SETANIM         4       # OP_SETANIM, label: transiciona para outra animacao
        .eqv OP_JUMP            5       # OP_JUMP, n: adiciona n instrucoes ao PC da animacao (n: signed int)
        .eqv OP_END             6       # OP_END, 0: termina a animacao atual
