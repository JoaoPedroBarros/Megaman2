# PROC_IMPRIMIR_TEXTURA_INVERTIDA_CI4
#
# Imprime uma textura comprimida com index de 4 bits
# dado uma paleta, invertida
#
# Argumentos:
...
PROC_IMPRIMIR_TEXTURA_INVERTIDA_CI4: 	
			...
			addi s0, a5, 8			# pega o primeiro elemento da paleta

			
			
# s0 = p  = endereco da paleta
...
P_IT5_PULA_PIXEL:	addi a0, a0, -1			# E--
			...
			bne a1, t4, P_IT5_LOOP
			j P_IT5_PROXIMA_LINHA



P_IT5_PROXIMA_LINHA_RAPIDO:    
...
P_IT5_NIBBLE2_R:	andi t1, t0, 0x0F
			...
			beq t1, t6, P_IT5_NIBBLE1_R	# SE ( I == COR_TRANSPARENTE ), PULA O PIXEL
                                                        # SENAO:
			sb t1,	(t3)			# 	imprime o pixel

P_IT5_NIBBLE1_R:	addi t3, t3, 1			# P++ 
			addi a1, a1, 1			# X++ 
			...
			beq t1, t6, P_IT5_PULA_PIXEL_RAPIDO
			sb t1, (t3)

P_IT5_PULA_PIXEL_RAPIDO:addi a0, a0, -1			# E--
			addi t3, t3, 1			# P++ 
			addi a1, a1, 1			# X++ 
			
			bne a1, t4, P_IT5_LOOP_RAPIDO
			# SE X == X_limite, VAI PARA A PROXIMA LINHA
			j P_IT5_PROXIMA_LINHA_RAPIDO		
